...
public class SwordGUIBuilder extends BuilderAbstract {
    ...
    public void init() {
        ...
        super.init(inv, 5, 46, "sharpness");
        super.init(inv, 2, 47, "fire-aspect");
        super.init(inv, 3, 48, "unbreaking");
        super.init(inv, 2, 49, "knock");
        super.init(inv, 3, 50, "looting");
        super.init(inv, 5, 51, "bane-of-arthropods");
        super.init(inv, 5, 52, "smite");
