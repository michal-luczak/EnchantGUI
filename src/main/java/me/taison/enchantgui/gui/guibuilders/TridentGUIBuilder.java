...
public class TridentGUIBuilder extends BuilderAbstract {
    ...
    public void init() {
        ...
        super.init(inv, 5, 46, "impaling");
        super.init(inv, 3, 47, "loyalty");
        super.init(inv, 3, 48, "unbreaking");
        super.init(inv, 3, 49, "riptide");
        super.init(inv, 1, 50, "channeling");
